...
class SetF1SeasonYear extends StatefulWidget {
  const SetF1SeasonYear({super.key, required this.currentSeasonYear});

  final String currentSeasonYear;

  @override
  State<SetF1SeasonYear> createState() => _SetSeasonYearState();
}

class _SetSeasonYearState extends State<SetF1SeasonYear> with SingleTickerProviderStateMixin {
  late AnimationController _animationController;
  late Animation<double> _animation;

  int currentYear = DateTime.now().year;
  String _seasonYear = "";
  int minSeasonYear = int.tryParse(SET_MIN_SEASON_YEAR_F1)!;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Set F1 Season Year"),
      ),
      body: SafeArea(
        child: Center(
          child: Column(
            children: [
              ...
              Visibility(
                ...
                child: Text(
                  "Currently Selected: ${widget.currentSeasonYear}",
